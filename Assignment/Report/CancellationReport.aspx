<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CancellationReport.aspx.cs" Inherits="Assignment.Report.CancellationReport" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        ...
        <h1 class="banner">Booking Cancellation Report</h1>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=(LocalDB)\v11.0;AttachDbFilename=|DataDirectory|\Member.mdf;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="Select Booking.MemberID,Name, Count(BookingId) From Member INNER JOIN Booking On Booking.MemberID=Member.MemberID where BookingStatus='Cancelled' Group By Name,Booking.MemberID"></asp:SqlDataSource>
    </form>
</body>
</html>
